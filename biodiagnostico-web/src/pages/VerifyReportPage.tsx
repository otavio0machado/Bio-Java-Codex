    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="border-b border-neutral-200 bg-white py-6">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 sm:px-6">
          ...
          <div>
            <h1 className="text-xl font-semibold text-neutral-900">Biodiagnostico</h1>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm">
              Este documento <strong>nao foi emitido pelo Biodiagnostico</strong> ou o hash
      ...
      {data.signed ? (
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm">
              Este laudo foi gerado e assinado digitalmente pelo Biodiagnostico.
            </p>
          </div>
        </div>
      ) : (
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm">
              Laudo gerado pelo Biodiagnostico, ainda sem assinatura do responsavel tecnico.
            </p>
          </div>
        </div>
      )}
