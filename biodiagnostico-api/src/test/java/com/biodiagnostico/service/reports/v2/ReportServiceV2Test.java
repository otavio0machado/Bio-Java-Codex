...
import com.biodiagnostico.service.reports.v2.generator.ReportGeneratorRegistry;
...
class ReportServiceV2Test {
    ...
    private final LabSettingsService labSettingsService = new LabSettingsService(null, null) {
        @Override public com.biodiagnostico.entity.LabSettings getOrCreateSingleton() {
