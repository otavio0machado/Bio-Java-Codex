...
import com.biodiagnostico.entity.PasswordResetToken;
import com.biodiagnostico.entity.User;
import com.biodiagnostico.exception.BusinessException;
import com.biodiagnostico.repository.PasswordResetTokenRepository;
...
public class PasswordResetService {
    ...
    @Value("${app.password-reset.from-email:${spring.mail.username:no-reply@biodiagnostico.local}}")
