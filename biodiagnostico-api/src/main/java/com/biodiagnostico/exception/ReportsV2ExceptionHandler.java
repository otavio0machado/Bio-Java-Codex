...
import com.biodiagnostico.service.reports.v2.InvalidFilterException;
import com.biodiagnostico.service.reports.v2.InvalidSignerException;
import com.biodiagnostico.service.reports.v2.RateLimitExceededException;
import com.biodiagnostico.service.reports.v2.ReportAlreadySignedException;
import com.biodiagnostico.service.reports.v2.ReportCodeNotFoundException;
import com.biodiagnostico.service.reports.v2.ReportExpiredException;
import java.net.URI;
...
public class ReportsV2ExceptionHandler {
    ...
    private static final URI TYPE_REPORT_CODE = URI.create("https://biodiagnostico.local/errors/reports-v2/code-not-found");
    private static final URI TYPE_INVALID_FILTER = URI.create("https://biodiagnostico.local/errors/reports-v2/invalid-filter");
    private static final URI TYPE_RATE_LIMIT = URI.create("https://biodiagnostico.local/errors/reports-v2/rate-limit");
    private static final URI TYPE_ALREADY_SIGNED = URI.create("https://biodiagnostico.local/errors/reports-v2/already-signed");
    private static final URI TYPE_EXPIRED = URI.create("https://biodiagnostico.local/errors/reports-v2/expired");
    private static final URI TYPE_INVALID_SIGNER = URI.create("https://biodiagnostico.local/errors/reports-v2/invalid-signer");
